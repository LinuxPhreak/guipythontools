...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.cbConvert, 2, 1, 1, 2)
        self.tbUI.addTab(self.tbUIMaker, "")
        self.tbVenv = QtWidgets.QWidget()
        self.tbVenv.setObjectName("tbVenv")
        self.gridLayout_4 = QtWidgets.QGridLayout(self.tbVenv)
        self.gridLayout_4.setObjectName("gridLayout_4")
        self.lblVenv = QtWidgets.QLabel(self.tbVenv)
        self.lblVenv.setObjectName("lblVenv")
        self.gridLayout_4.addWidget(self.lblVenv, 0, 0, 1, 1)
        self.tbVenv_2 = QtWidgets.QLineEdit(self.tbVenv)
        self.tbVenv_2.setObjectName("tbVenv_2")
        self.gridLayout_4.addWidget(self.tbVenv_2, 0, 1, 1, 1)
        self.cbCreate = QtWidgets.QPushButton(self.tbVenv)
        self.cbCreate.setObjectName("cbCreate")
        self.gridLayout_4.addWidget(self.cbCreate, 1, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lblVenv.setText(_translate("MainWindow", "VM Location"))
        self.cbCreate.setText(_translate("MainWindow", "Create"))
